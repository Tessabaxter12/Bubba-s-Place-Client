...
const LocationDetails = () => {
    return (
        <div className="location-container">
            <div className="maps">
                <img className="willowCreek" src="/willowCreek.png" alt="Aerail Map Of Willow Creek" width="400" height="300"/>
                <img className="willowCreek" src="/willowCreek2.png" alt="Google Map Of Willow Creek" width="400" height="300"/>
            </div> 
            <h3>Bubba's Place Is Located In The Town Of Willow Creek</h3>
